          ...
          <div class="col-md-3">
            <nuxt-link :to="`/course/${$route.params.id}/lectures`">
              <div class="level-item box-shadow-class">
                <img style="margin-top:40px;width:100px;" src="@/assets/imgs/lecture.svg" alt="">
           ...
           <div class="col-md-3">
            <nuxt-link :to="`/course/${$route.params.id}/folders`">
              <div class="level-item box-shadow-class">
                <img style="margin-top:40px;width:100px;" src="@/assets/imgs/test.svg" alt="">
           ...
           <div class="col-md-3">
            <nuxt-link :to="`/course/${$route.params.id}/timeline`">
              <div class="level-item box-shadow-class">
                <img style="margin-top:40px;width:100px;" src="@/assets/imgs/timeline.svg" alt="">
                <h6>التايم لاين</h6>
            </div>
            </nuxt-link>
          </div>
