                  ...
                  <div class="col-md-3" v-for="teacher in teachers" :key="teacher.id">
                      <div class="teacher-card">
                          <div class="teacher-img">
                               <i style="color:#2295c9;color: rgb(57 160 207);padding: 0 12px;" class="fas fa-star"></i>
                                <div>
                                   <img src="../assets/imgs/logo.png" class="background-logo" alt="">
                                    <img v-if="teacher.photo" :src="teacher.photo"> 
                                    <img v-else src="https://res.cloudinary.com/derossy-backup/image/upload/v1555206304/deross-samples/placeholder-profile-male.jpg"> 
                          ...
                          <div class="teacher-body">
                              ...
                              <h6 style="font-family: 'CustomFontBold';margin-bottom: 0;font-size: 19px;background: rgb(255 255 255 / 10%);padding: 10px;"><i class="fas fa-circle"></i> {{teacher.username}} </h6>
...
export default {
    ...
    created(){
        this.$axios.get('/statistics/teachers/subjects').then(res => {
