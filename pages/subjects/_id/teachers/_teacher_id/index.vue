<template>
  <div class="teacher-info">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h6 class="teacher-info-div">معلومات المدرس</h6>
          <!-- {{ teacher_id }}
          <hr />
          {{ subject_id }} -->
          ...
          <h6 class="teacher-info-div">
            <nuxt-link
              :to="'/lecture'"
              style="font-family: 'CustomFontBold'; color: #676767;"
            >
              المحاضرات
            </nuxt-link>
          </h6>
        ...
        <div class="col-md-6">
          <div class="teacher-buttons">
            ...
            <nuxt-link :to="teacher_id + '/exams'">
              <button class="last-btn">الإمتحانات العامة</button>
            </nuxt-link>
          </div>
        </div>
      </div>
