...
<!--
    ...
    <div class="loggedDropdown" style="width:16%;position: relative;">
              <vs-dropdown
                        ...
                        <a class="a-icon" href="#">
                         <h6 v-if="$auth && $auth.loggedIn && $auth.user && $auth.user.username" style="margin-bottom:0;display:inline-block">{{ $auth.user.username.includes(' ') ? $auth.user.username.substr(0,$auth.user.username.indexOf(' ')) : $auth.user.username }}</h6>
